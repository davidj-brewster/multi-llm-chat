...
def test_text_generation():
    ...
    # Generate a response
    prompt = "Write a very short three-sentence story about a unicorn for a bedtime story."
    system_instruction = "You are a helpful assistant that specializes in short, creative stories."
...
def test_image_analysis(image_paths):
    ...
    logger.info(f"Testing image analysis with responses API using {len(image_paths)} images")
    ...
    system_instruction = "You are a helpful assistant that specializes in image analysis."
...
def test_chunking():
    ...
    system_instruction = "You are a helpful assistant that specializes in summarization."
