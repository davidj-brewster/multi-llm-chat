...
class MockResponses:
    ...
    def create(self, model=None, system=None, input=None, max_tokens=None, temperature=None, **kwargs):
        ...
        logger.info(f"Input: {input[:100] if isinstance(input, list) and input else input}")
        ...
        mock_content_item.text = "This is a mock response from the OpenAI responses API."
